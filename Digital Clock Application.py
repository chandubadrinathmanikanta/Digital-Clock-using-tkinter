...
# This Program is created by R.Chandu BNM
...
root.title('Digital Clock by R.Chandu BNM')
...
label = Label(root, anchor='center', font=("ds-digital", 90), background="black", foreground="cyan")
label.pack(fill=X)
